...
import LogoutAction from '../../auth/components/LogoutAction';

jest.mock('../../auth/hooks/use-auth');
jest.mock('../components/OrderHistoryAction', () => jest.fn(() => null));
jest.mock('../../auth/components/LogoutAction', () => jest.fn(() => null));
