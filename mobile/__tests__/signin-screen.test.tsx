...
jest.mock('../src/assets/images/lock_icon.png', () => 0);
jest.mock('../src/assets/images/biometric_icon.png', () => 0);
jest.mock('../src/assets/images/google_icon.png', () => 0);
jest.mock('../src/assets/images/facebook_icon.png', () => 0);
